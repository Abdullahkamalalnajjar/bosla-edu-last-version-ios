...
import 'package:edu_platform_app/presentation/widgets/welcome_overlay.dart';
...
class _LoginScreenState extends State<LoginScreen>
  ...
  void initState() {
    ...
    // Hide status bar for immersive login experience
  ...
  void dispose() {
    ...
    // Restore status bar when leaving login screen
    SystemChrome.setEnabledSystemUIMode(
      SystemUiMode.manual,
    ...
    if (response.succeeded && response.data != null) {
      ...
      if (roles.contains('Admin')) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => MainScreen(welcomeName: response.data!.firstName),
          ),
        );
      } else if (roles.contains('Parent')) {
        Navigator.pushReplacement(
