...
class SelectSubjectScreen extends StatefulWidget {
  ...
  const SelectSubjectScreen({super.key, this.welcomeName});
...
class _SelectSubjectScreenState extends State<SelectSubjectScreen>
  ...
  void initState() {
    ...
    // Show welcome banner if name passed
    if (widget.welcomeName != null && widget.welcomeName!.isNotEmpty) {
      WidgetsBinding.instance.addPostFrameCallback((_) {
        if (mounted) setState(() => _showWelcomeBanner = true);
  ...
  Future<void> _loadUserName() async {
    if (widget.welcomeName != null) {
      if (mounted) setState(() => _userName = widget.welcomeName);
      return;
    }
    ...
    return Column(
      ...
      children: [
        ...
        AnimatedSlide(
          ...
          offset: _showWelcomeBanner ? Offset.zero : const Offset(0, -1.5),
