          ...
          AnimatedContainer(
            ...
            decoration: BoxDecoration(
              ...
              gradient: LinearGradient(
                ...
                colors: isDark
                    ? [
                        Colors.white.withOpacity(_isSearchFocused ? 0.08 : 0.04),
                        Colors.white.withOpacity(_isSearchFocused ? 0.04 : 0.02),
                      ]
                    : [
                        Colors.white.withOpacity(_isSearchFocused ? 0.95 : 0.85),
                        Colors.white.withOpacity(_isSearchFocused ? 0.9 : 0.75),
                      ],
              ),
              border: Border.all(
                color: _isSearchFocused
                    ? AppColors.primary.withOpacity(isDark ? 0.5 : 0.4)
                    : (isDark
